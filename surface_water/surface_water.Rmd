...
[Screen-Capture of Interactive Tool Available Online]("/Users/stubbsrw/Documents/git_code/stubbs_repo/fe_problems/surface_water/intearactive_screencap.png")
...
mod <- lme4::lmer(StandardResult  ~ 1+ (1|Year)+(1|Season),data=analyte)
summary(mod)
```
...
for ( a in unique(sw$StandardAnalyte)){
  ...
  # Start a PDF document of results
    pdf(paste0("/Users/stubbsrw/Documents/git_code/stubbs_repo/fe_problems/surface_water/",a,".pdf"))
